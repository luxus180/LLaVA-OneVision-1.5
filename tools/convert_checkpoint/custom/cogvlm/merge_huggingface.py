...
language_expert = load_huggingface_checkpoint(args.language_expert_path)
vision_expert = load_huggingface_checkpoint(args.vision_expert_path)
...
for module in [vision_expert, vision_model, adapter, patch]:
    merge_dict(module, language_expert)

save_huggingface_checkpoint(language_expert, args.save_ckpt_path)