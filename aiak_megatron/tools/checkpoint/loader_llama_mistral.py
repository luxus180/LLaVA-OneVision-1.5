...
def add_arguments(parser):
    ...
    parser.add_argument('--model-size', type=str, required=True,
                        choices=['llama2-7B', 'llama2-13B', 'llama2-70B', 'llama2-7Bf', 'llama2-13Bf',
                                 'llama2-70Bf', 'llama3', 'mistral', 'yi-34B', 'qwen2.5'],
...
def load_checkpoint_to_model(args):
    ...
    hf_model = AutoModelForCausalLM.from_pretrained(args.load, torch_dtype=args.params_dtype,
...
def _load_checkpoint(queue, args):
    ...
    if args.checkpoint_type == "meta":
        model_tmp_path = convert_to_hf(model_path=os.path.join(args.save_dir, 'tmp'), input_base_path=args.load_dir,
                                       model_size=args.model_size, tokenizer_path=args.tokenizer_model)
