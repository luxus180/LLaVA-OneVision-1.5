...
class FaissParallelAddIndex(FaissBaseIndex):
    ...
    def save_block(self, config: RetroPreprocessingConfig, block: dict, codes: np.ndarray) -> None:
        ...
        Args:
            ...
            block (dict): Range information specifying the start/end indices within the encoded text dataset.
                Here, the 'path' item is used for writing the encodings to storage.
