...
def get_text_dataset_for_adding(config: RetroPreprocessingConfig) -> GPTToTextDataset:
    ...
    Returns:
        The text dataset that consists of tokens converted from the 'train' chunk database. These are the chunks used
            for retrieval by the pretraining 'train' dataset.
    """
